...
| # | 文件 | 对照原版 | 内容 | 博客 |
|---|---|---|---|---|
| 1 | `ddpm.py` | `../ddpm.py` | 简化 U-Net(Add skip)+ LAMB + EMA + DDPM 训练/采样;含 Min-SNR 开关 | [9119](https://kexue.fm/archives/9119) |
...
| 6 | `ddpm_gau.py` | `../ddpm-gau.py` | GAU Transformer 去噪器(8×8 patch + 2D-RoPE),88M 参数,早期 DiT | [8934](https://kexue.fm/archives/8934) |
...
- `ddpm.py`:参数量 50,514,176 与 Keras 版**完全一致**;epoch 1 loss 27.5k vs Keras 版 26.8k(跨框架吻合);GPU 训练 5.1 it/s(快于 Keras 版 2.8)
